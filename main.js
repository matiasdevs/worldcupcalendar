...
document.querySelector('#cards').innerHTML =
      ...
      createCard('05/12', 'domingo',
        createGame('france', '3 x 1', 'poland', 'fim do jogo') +
        createGame('england', '3 x 0', 'senegal', 'fim do jogo')
        ) +
      createCard('06/12', 'segunda',
        createGame('japan', '1 x 3', 'croatia', 'fim do jogo') +
        createGame('brazil', '4 x 1', 'south korea', 'fim do jogo')
        ) +
      createCard('07/12', 'terça',
        createGame('morocco', '3 x 0', 'spain', 'fim do jogo') +
        createGame('portugal', '6 x 1', 'switzerland', 'fim do jogo')
        ) +
      createCard('09/12', 'sexta',
        createGame('croatia', '4 x 2', 'brazil', 'fim do jogo') +
        createGame('netherlands', '3 x 4', 'argentina', 'fim do jogo')
        ) +
      createCard('10/12', 'sabado',
        createGame('morocco', '1 x 0', 'portugal', 'fim do jogo') +
        createGame('england', '1 x 2', 'france', 'fim do jogo')
        ) +
      ...
      createCard('17/12', 'sabado',
        createGame('croatia', '2 x 1', 'morocco', 'fim do jogo')
        ) +
      createCard('18/12', 'domingo',
        createGame('argentina', '3 x 2', 'france', 'FINAL')
        )
  ;
